<header>
    <nav class="navbar" style="background-color: #e3f2fd;">
      ...
      <ul class="nav-links">
          ...
          $tenNguoiDung = $_SESSION['user_name'];
          $idNguoiDung = $_SESSION['id'];
          echo '<li><a href="includes/addyeuthich.php" style="color: #f15a5a; padding: 1em 1em; border: 1px solid #635454; border-radius: 90px;">';
          echo '<i class="fas fa-heart"></i> Yêu thích </a></li>';
          echo '<a href="page/info.php ?TK_ID='.$idNguoiDung;
          echo '">';  
          ...
          echo '<li><a id="login-btn" href="/t3/login_form/login.php" style="color: #000; padding: 1em 1em; border: 1px solid #635454; border-radius: 90px;">Đăng nhập</a></li>';
          echo '<li><a id="signup-btn" href="/t3/login_form/login.php?register=true" style="color: #000; padding: 1em 1em; border: 1px solid #635454; border-radius: 90px;">Đăng ký</a></li>';
        }
        ?>
      </ul>
    </nav>
  ...
  <script>
      function changeColor(dropdown) {
        ...
        window.location.href = 'page/process.php?hdId=' + hdId;
      }
    </script>